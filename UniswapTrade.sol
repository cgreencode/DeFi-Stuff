...
contract UniswapTrade {
    ...
    // Buys the ERC20 token from one of the liquidity pools
    // Payable: the ether you want to trade for the ERC20 token
    function buy() external payable {
       ...
       // calculates how many of this ERC20 token you can get with the amount of ether you're sending with this buy() call
       ...
       uniswapExchange.ethToTokenTransferInput.value(msg.value)(
           tokenAmount, // minimum amount of tokens to receive i.e. equivalent of eth you sent
           now + 300, // valid period of this trade (5 mins)
